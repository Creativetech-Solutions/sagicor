...
<?php
if(isset($data['loggedinuser']->id))
    $userEmail = getEmailById($data['loggedinuser']->id);
...
?>
<div class="text-left row content-wrapper">
...
<?php $this->load->view('site/pages/registration/steps_nav');?>
    ...
    <form class="register-form" id="submitForm" action="<?= base_url()?>registration/step2_passport" method="post">
        ...
        <div class="info-wrap">
            <div class="form-group">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- title selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- dob month selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- dob year selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- Name badge field 1 -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- Name badge field 2 -->
            ...
            <div class="clearfix"></div>
            <?php if($club == 1 || $data['tempUser']->club == 1) { ?>
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- country selection -->
           ...
           <strong class="help-block">Contact Information</strong>
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        ...
                        <input type="text" value="<?=$home?>" name="home_phone" id="home-phone" data-format="ddddddddddddddd" class="form-control input-medium bfh-phone">
                    </div>
                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <label>Work Phone</label>

                        <input type="text" value="<?=$work?>" name="work_phone" id="work-phone" data-format="ddddddddddddddd" class="form-control input-medium bfh-phone">
                    ...
                    <div class="help-block col-lg-12">Include area code in contact numbers</div> 
            </div>

            <div class="clearfix"></div>

            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- email Street Address 1 field -->
                <label>E-mail</label>
                <input type="email" value="<?=$userEmail?>" name="email" id="email" readonly placeholder="" class="form-control" >

            </div>

            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- email Street Address 2 field -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-8 col-lg-6"><!-- Street Address 1 field -->
            ...
            <div class="clearfix"></div>
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4" id="address-info"><!-- city field -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 zip_address"><!-- zip code field -->
        ...
        <div style="display: none;" class="info-wrap" id="guest-info">
            ...
            <?php if($club_g == 1 || $data['tempUser']->club == 1) { ?>
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4">
 ...
 -->
            ...
            <div id="address-info_g" class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- city field -->

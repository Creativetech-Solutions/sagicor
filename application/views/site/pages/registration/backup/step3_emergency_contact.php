...
<div class="row">
    ...
    <ul class="progress-indicator">
        ...
        <li class="active">
            ...
            <strong>3. <small>Emergency Contact</small></strong>
    ...
    <form action="<?=base_url()?>registration/step4_flights_accommodation" method="post">
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="form-inline"><!-- contact information fields -->
                ...
                <label>Home</label> <input type="text" value="<?=$emergency_home?>" name="emergency_home_phone" id="emergency-home-phone" data-format="ddddddddddddddd" class="form-control right10 input-medium bfh-phone">

                <div class="clearfix"></div>
                <label>Work</label> <input type="text" value="<?=$emergency_work?>" name="emergency_work_phone" id="emergency-work-phone" data-format="ddddddddddddddd" class="form-control right10 input-medium bfh-phone">

                <label>Cell</label> <input type="text" value="<?=$emergency_cell?>" name="emergency_cell_phone" id="emergency-cell-phone" data-format="ddddddddddddddd" class="form-control input-medium bfh-phone"><br>

                <span class="help-block">Include area code in contact numbers</span>
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="form-inline"><!-- contact information fields -->
                ...
                <label>Dr. Alt Phone</label> <input type="text" value="<?=$dr_alt_phone?>" name="dr_alt_phone" id="dr-alt-phone" data-format="ddddddddddddddd" class="form-control input-medium bfh-phone"><br>
        ...
        <div class="form-group col-xs-5"><!-- special occasion field -->
            ...
            <div style="display: block;" id="guest-info">
                ...
                <div class="form-group col-xs-12">
                    ...
                    <div class="form-inline"><!-- contact information fields -->
                        ...
                        <label>Home</label> <input type="text" value="<?=$emergency_home_g?>" name="emergency_home_phone_g" id="emergency-home-phone-g" data-format="ddddddddddddddd" class="form-control right10 input-medium bfh-phone">

                        <div class="clearfix"></div>
                        <label>Work</label> <input type="text" value="<?=$emergency_work_g?>" name="emergency_work_phone_g" id="emergency-work-phone-g" data-format="ddddddddddddddd" class="form-control right10 input-medium bfh-phone">

                        <label>Cell</label> <input type="text" value="<?=$emergency_cell_g?>" name="emergency_cell_phone_g" id="emergency-cell-phone-g" data-format="ddddddddddddddd" class="form-control input-medium bfh-phone"><br>
                ...
                <label>Primary Doctor</label> 
                        ...
                        <label>Dr. Alt Phone</label> <input type="text" value="<?=$dr_alt_phone_g?>" name="dr_alt_phone_g" id="dr-alt-phone-g" data-format="ddddddddddddddd" class="form-control input-medium bfh-phone"><br>

...
<form method="post" action="<?=base_url()?>registration/final_message">
    ...
    <div class="form-group col-xs-2"><!-- country selection -->
    ...
    <div class="form-group col-xs-4"><!-- name as it appears on credit card field -->
    ...
    <div class="form-group col-xs-3"><!-- credit card number field -->
    ...
    <div class="form-group col-xs-3"><!-- cc expire month selection -->
    ...
    <div class="form-group col-xs-2"><!-- cc expire year year selection -->
    ...
    <div class="form-group col-xs-3"><!-- Security Code CVV2 field -->
    ...
    <div class="form-group col-xs-3"><!-- zip code field -->
    ...
    <div class="form-group">
        ...
        <div>
            ...
            <button class="btn btn-warning left10" id="accept" name="accept" type="submit" style="display: <?php echo $acceptshow; ?>;">Accept Registration</button>

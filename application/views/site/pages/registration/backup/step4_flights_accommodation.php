...
<ul class="progress-indicator">
    ...
    <li class="active">
        ...
        <strong>4. <small>Flights and Accommodation</small></strong>
...
<form method="post" action="<?=base_url()?>registration/step5_activities">

    <h3 class="left30">Winner Information</h3>

    <div class="clearfix"></div>

    <div class="form-group col-xs-4 left15"><!-- frequent flyer selection -->
    ...
    <div class="form-group col-xs-4"><!-- frequent flyer number -->
   ...
   <div class="form-group col-xs-3 left15"><!-- frequent flyer airline selection -->
    ...
    <div class="form-group col-xs-4" id="ffno-info" style="display:<?= ($ff_airline === 'other')?'block':'none'; ?>;"><!-- frequent flyer number -->
   ...
   <div class="clearfix"></div>
    ...
    <div class="form-group col-xs-6 left15"><!-- frequent flyer alt selection -->
   ...
   <div class="form-group col-xs-3 left15"><!-- frequent flyer airline selection -->
    ...
    <div class="form-group col-xs-4" id="off-info-alt" style="display:<?=($ff_airline_alt === "other")?'block':'none'; ?>;"><!-- frequent flyer number -->
    ...
    <div class="form-group col-xs-7 left15"><!-- seating selection -->
    ...
    <div class="form-group col-xs-7 left15"><!-- luggage selection -->
    ...
    <div class="form-group col-xs-7 left15"><!-- bed configuration selection -->
    ...
    <div class="form-group col-xs-5 left15"><!-- airport code field -->
    ...
    <div class="form-group col-xs-5 left15"><!-- depart location selection -->
        ...
        <select class="form-control select" id="depart-date" name="depart_date" onchange="homeCheck(this);">
            ...
            <option></option>
               <?php 
                    if($club == 0) 
                        $optVal = 'On group date - Monday, June 11';
    ...
    <div class="form-group col-xs-8 left15" id="airnote-info" style="display:<?=($depart_date === 'other')?'block':'none';?>;">
        ...
        <textarea class="form-control" id="air-note" name="air_notes_dpt" placeholder="Please detail your specific travel request, indicating preferred dates and whether you are planning to advance/extend in Barcelona."><?php echo $air_notes_dpt; ?></textarea>
    ...
    <div class="form-group col-xs-8 left15" id="homenote-info" style="display:<?php echo $showHomenote; ?>;">
        ...
        <textarea class="form-control" id="air-note" name="air_notes" placeholder="Please detail your specific travel request, indicating preferred dates and whether you are planning to advance/extend in Barcelona."><?=$air_notes; ?></textarea>

    </div>

    <div class="form-group col-xs-8 left15" id="travelreq-info" style="display:<?php echo $showTravelreq; ?>;">
    ...
    <?php if($Companion == 'Yes') { ?> 
        ...
        <div class="clearfix"></div>
        <div class="form-group col-xs-8 left15" id="airnote-info_g" style="display:<?=($depart_date_g === 'other')?'block':'none'; ?>;">

            <label>Departure Notes for Air Travel</label>

            <textarea class="form-control" id="air-note_g" name="air_notes_gdpt" placeholder="Please detail your specific travel request, indicating preferred dates and whether you are planning to advance/extend in Barcelona."><?=$air_notes_dpt_g ?></textarea>

        </div>



        <div id="home-info_g" class="form-group col-xs-5 left15" style="display:block;"><!-- return location selection -->
        ...
        <div class="clearfix"></div>
            <div class="form-group col-xs-8 left15" id="homenote-info_g" style="display:<?=($return_date_g === 'other')?'block':'none';?>;">

                <label>Returning Notes for Air Travel</label>

                <textarea class="form-control" id="air-note_g" name="air_notes_g" placeholder="Please detail your specific travel request, indicating preferred dates and whether you are planning to advance/extend in Barcelona."><?=$air_notes_g?></textarea>

            </div>

            <div class="form-group col-xs-8 left15" id="travelreq-info_g" style="display:<?=($return_date_g !== 'other')?'block':'none';?>;">

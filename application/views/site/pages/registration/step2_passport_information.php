...
if($data['userData']->visa_exp_date == '0000-00-00')
    $visa_exp = "";
else
...
if(isset($data['guestData']) && is_object($data['guestData'])){
    ...
    if($data['guestData']->visa_exp_date == '0000-00-00')
        $visa_exp_g = "";
    else
...
<?php $this->load->view('site/pages/registration/steps_nav');?>
    ...
    <form class="register-form" action="<?= base_url() ?>registration/step3_emergency_contact" method="post">
        ...
        <div class="wrap-info">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- passport# field -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- citizenship field -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!--passport city field -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- issue month selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- issue date selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- issue year selection -->
                ...
                <select name="pp_issue_year" id="pp-issue-year" class="form-control select">
                    ...
                    <option <?= (isset($pp_issue_year) && ($pp_issue_year === "2017" ))?'selected="selected"':"" ?> value="2017">2017</option>
                    <option <?= (isset($pp_issue_year) && ($pp_issue_year === "2018" ))?'selected="selected"':"" ?> value="2018">2018</option>
                </select>
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- expire month selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- expire date selection -->
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- expire year selection -->
            ...
            <div class="visatype hide-on-vtype" id="visaType">

                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-4"><!--Schengen Visa Number -->
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-4"><!--Schengen Visa Number -->
                    ...
                    <div data-date="<?=$visa_exp?>" data-name="visa_exp_date" data-format="y-m-d" class="bfh-datepicker">
                        <div data-toggle="bfh-datepicker" class="input-group bfh-datepicker-toggle"><span
                                ...
                                type="text" placeholder="" value="<?=$visa_exp?>" class="form-control" name="exp_date"></div>
            ...
            <div class="clearfix"></div>
            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-9 hide-on-vtype"><!-- US visa selection -->
            ...
            <div id="visa-info" class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-4 hide-on-vtype"><!-- US visa selection -->
        ...
        <div style="display: block;" class="wrap-info" id="guest-info">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- passport# field -->
                ...
                <input type="text" value="<?=$passport_g?>" name="passport_g" id="passport-g" placeholder=""
                       class="form-control">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!--passport city field -->
                ...
                <input type="text" value="<?=$issue_city_g?>" name="issue_city_g" id="issue-city-g"
                       placeholder="" class="form-control">
            ...
            <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4"><!-- issue year selection -->
                ...
                <select name="pp_issue_year_g" id="pp-issue-year_g" class="form-control select">
                    ...
                    <option <?= (isset($pp_issue_year_g) && ($pp_issue_year_g === "2017" ))?'selected="selected"':"" ?> value="2017">2017</option>
                    <option <?= (isset($pp_issue_year_g) && ($pp_issue_year_g === "2018" ))?'selected="selected"':"" ?> value="2018">2018</option>
                </select>
            ...
            <div class="visatype hide-on-vtype" id="visaType_g">
                ...
                <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-4"><!--Schengen Visa Number -->
                    ...
                    <div data-date="<?=$visa_exp_g?>" data-name="visa_exp_date_g" data-format="y-m-d" class="bfh-datepicker">
                        <div data-toggle="bfh-datepicker" class="input-group bfh-datepicker-toggle"><span
                                class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span><input
                                type="text" placeholder="" value="<?=$visa_exp_g?>" class="form-control" name="exp_date_g"></div>
                        <div class="bfh-datepicker-calendar">
                            <table class="calendar table table-bordered">
                                <thead>
                                <tr class="months-header">
           ...
           <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-9 hide-on-vtype">
                <span class="help-block">Do you have a valid US Visa, OR Do you hold a valid US Resident Card/Green Card?</span>
            ...
            <div class="clearfix"></div>
            <div id="visa-info_g" class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-4 hide-on-vtype">
        ...
        <div class="form-group left30">
            ...
            <div>
                <input type="hidden" name="s_type" value="next" />
               <!--  <a role="button" class="btn btn-success"
                   href="<?= base_url() ?>registration/register">Previous</a> -->
                   <input type="hidden" name="redirect_to" value="" />
                <button type="submit" name="prev_update" id="prev_update" value="" class="btn btn-success left10 submit-btn">Previous</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function(e){
        ...
        visaCheck($($('.country-visa')[1]).val(), $($('.country-visa')[1]));
    })
    function visaCheck(value, ref){
        $parent = ref.parents('.wrap-info');
        if(value == 28 || value == 147){ //united state or canada
            $parent.find('.hide-on-vtype').hide();
        } else $parent.find('.hide-on-vtype').show();
    ...
    $(document).on('click','.submit-btn',function(e){
        ...
        if($.isEmptyObject($msg)){
            if(id == 'update') $("input[name='s_type']").val("next");
            else  $("input[name='s_type']").val("previous");
            $("form").submit();
        } else {
            $('html, body').animate({
    ...
    function checkPassportDate(){
        ...
        $(".error-noti").append("To continue, please leave your passport expiration fields empty.");
        return $msg;
    }
</script>
     </div>
